...
//        ArcheryGame archeryGame = new ArcheryGame();
//
//        ArcheryPlayer[] players = archeryGame.getPlayers();
...
//            for (archeryPlayer player : players) player.play(archeryGame);
//
//        }
//
//        System.out.println(Arrays.deepToString(scoreBoard));
//
//        ArcheryPlayer player = archeryGame.getWinner();
...
//        ArcheryGame archeryGame = new ArcheryGame();
//
//        for(ArcheryPlayer player:archeryGame.getPlayers()){
