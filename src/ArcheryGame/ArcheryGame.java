...
import java.util.Arrays;
    ...
    public class ArcheryGame{
        ...
        private ArcheryPlayer[] players;
        private int[][] scoreBoard;
        private int[] totalOfScores;
        private ArcheryPlayer winner;

        public ArcheryGame(){
            ArcheryPlayer playerOne = new ArcheryPlayer(1);
            ArcheryPlayer playerTwo = new ArcheryPlayer(2);
            ArcheryPlayer playerThree = new ArcheryPlayer(3);
            ArcheryPlayer playerFour = new ArcheryPlayer(4);

            players = new ArcheryPlayer[4];
        ...
        public ArcheryPlayer[] getPlayers(){
            return players;
        }
        ...
        public ArcheryPlayer getWinner() {
            return winner;
        }
